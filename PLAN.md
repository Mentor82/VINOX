...
2. lexikalische Suche ueber FTS5,
3. Relationssignale wie Zitate, gleiche Entitaeten oder direkte Nachbarschaft.

Die Kandidaten werden normalisiert, gewichtet zusammengefuehrt und mit Quelle,
Score und Textspanne zurueckgegeben. Embeddings werden asynchron in Batches
erzeugt. Loeschen und Re-Embedding bleiben transaktional nachvollziehbar.
...
- Chatverlauf mit Verzweigungen persistieren
- Qwen3-Embedding-Backend mit Pooling und Normalisierung implementieren
- FTS5 und `sqlite-vec` zu hybrider Suche verbinden
- typisierte Relationen, Evidenz und rekursive Abfragen implementieren
- Loeschen, Export, Import und Backup absichern

**Ergebnis:** Chats und Dokumente sind dauerhaft, semantisch durchsuchbar und
ueber belegte Relationen miteinander verknuepfbar.
...
- konkrete `sqlite-vec`-Version und Einbindung als statische oder ladbare Extension
