    ...
    while (std::getline(std::cin, line)) {
        ...
        try {
            ...
            if (method == "initialize") {
                ...
                t_search["inputSchema"] = nlohmann::json::parse("{\"type\":\"object\",\"properties\":{\"query\":{\"type\":\"string\"}},\"required\":[\"query\"]}");
                ...
                t_conv["inputSchema"] = nlohmann::json::parse("{\"type\":\"object\",\"properties\":{\"conversation_id\":{\"type\":\"string\"}},\"required\":[\"conversation_id\"]}");
                ...
                t_ingest["inputSchema"] = nlohmann::json::parse("{\"type\":\"object\",\"properties\":{\"title\":{\"type\":\"string\"},\"content\":{\"type\":\"string\"}},\"required\":[\"title\",\"content\"]}");
                ...
                t_rel_q["inputSchema"] = nlohmann::json::parse("{\"type\":\"object\",\"properties\":{\"entity_id\":{\"type\":\"string\"}},\"required\":[\"entity_id\"]}");
                ...
                t_rel_c["inputSchema"] = nlohmann::json::parse("{\"type\":\"object\",\"properties\":{\"source\":{\"type\":\"string\"},\"target\":{\"type\":\"string\"},\"type\":{\"type\":\"string\"}},\"required\":[\"source\",\"target\",\"type\"]}");
